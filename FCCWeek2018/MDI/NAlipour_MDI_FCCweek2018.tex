...
\begin{frame}
	...
	\column{0.5\textwidth}
		...
		\item Most of the hits are due to the generation of secondary particles due to the interaction of $\gamma\gamma\rightarrow e^{+}e^{-}$ with the beampipe  \vspace{0.2cm}
...
\begin{frame}
	...
	\begin{itemize}
	\item Occupancy vs. DCH radius per BX
		\begin{itemize}
