...
\begin{frame}
	...
	\item In this example no track of pairs reaches the tracker \vspace{0.2cm}
	\end{itemize}
...
\begin{frame}
	...
	\column{0.5\textwidth}
		...
		\item Most of the hits come from the back scatterings \vspace{0.2cm}
		\item On average $\sim2000$ wires per BX are hit in the DCH (3.5\% of occupancy). \vspace{0.2cm}
		\item Acceptable level of occupancy for tracking: $5\%$
		\end{itemize}	
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Impact of incoherent pairs in the DCH: occupancy per layer}

	\begin{itemize}
	\item Occupancy as a function of the DCH layer for one BX
		\begin{itemize}
		\item The occupancy vs. DCH layer remains in acceptable ranges
		\item More investigations are needed
		\end{itemize}
	\end	{itemize}
	...
	\begin{itemize}
	\item Loopers vs. tracks going through the detector
	\end{itemize}
	...
	\begin{itemize}
	\item Acceptance levels of occupancy:
		\begin{itemize}
...
\begin{frame}
  \frametitle{Segmentation Strategy for DCH (1)}
